                            ...
                            <div>
                                ...
                                <div className="gap-3 flex justify-start mt-3 p-2">
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        disabled={!categoriaSelect || !puede("eliminar_categoria")}
                                        className={`rounded-md text-white font-semibold disabled:opacity-50 disabled:cursor-no-drop p-2 ${categoriaSelect ? "bg-red-500 cursor-pointer" : "bg-gray-400 cursor-not-allowed opacity-50"
                                            }`}
                                    >
                                        Borrar Categoria
                                    </button>
                        ...
                        {movimientos === "active" && (
                            <>
                                    ...
                                    <div className="flex justify-end items-center">
                                        <span className="bg-[#359bac] p-2 text-white rounded-md mb-2">Artículos en esta categoría: {articulo.length}</span>
                                    </div>

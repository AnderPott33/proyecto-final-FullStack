...
export const PERMISOS = {
  SUPERADMIN: {
    ...
    paginas: ["usuarios", "caja", "reportes", "configuracion","movimientos_caja","cuentas", "saldos_cuentas", "compra", "usuarios", "analitico", "contabilidad", ...GLOBAL_PAGINAS]
  },
  ADMIN: {
    ...
    paginas: ["usuarios", "caja", "reportes","movimientos_caja","cuentas", "saldos_cuentas", "compra", "usuarios", "analitico", "contabilidad" , ...GLOBAL_PAGINAS]
  },
  CONTABILIDAD: {
    acciones: ["crear", "editar", "cerrar_caja", "ver_relatorios_financieros", "alterar_fecha_caja",
